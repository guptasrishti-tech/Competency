...
## SECTION 4: ASSUMPTIONS, DEPENDENCIES & OUT OF SCOPE [~2 Minutes]

"The SOW clearly defines what was in scope and what was not. Let me address both.

---

**Assumptions and Dependencies**

The SOW states: 'The engagement assumes administrative access to relevant AWS environments and availability of historical cost data through AWS billing reports. Successful execution depends on timely stakeholder participation for infrastructure optimization decisions and governance approvals.'

How this played out: The client provided administrative access to their AWS environments as required. Historical billing data was available through AWS billing reports, which we used during the Discovery phase to baseline costs. Stakeholder participation was timely — the weekly governance meetings ensured decisions were made on schedule. There were no delays caused by unmet assumptions.

---

**Out of Scope**

The SOW explicitly excludes four items:

1. Application-level AI model development or algorithm improvements — We optimized the infrastructure that runs the AI models, not the models themselves.

2. Optimization of infrastructure outside AWS environments — Our scope was limited to the AWS cloud environment. Any remaining on-premises infrastructure was not in scope.

3. Long-term managed services beyond the scope of this engagement — This was a time-bound consulting engagement, not an ongoing managed services contract. Post-engagement support is under a separate advisory agreement.

4. Security remediation unrelated to cloud governance and FinOps controls — We addressed security as it relates t